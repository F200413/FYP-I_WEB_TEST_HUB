...
const SideNavbar = ({ workspaces }: any) => {
  ...
  const b = <li>
    ...
    >
      ...
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 512 512"
        className="flex-shrink-0 w-8 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white fill-current"
      >
  ...
  const c = <li>
    ...
    >
      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"
        className="flex-shrink-0 w-8 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white fill-current"
      >
        <path d="M64 464c-8.8 0-16-7.2-16-16V64c0-8.8 7.2-16 16-16H224v80c0 17.7 14.3 32 32 
    32h80V448c0 8.8-7.2 16-16 16H64zM64 0C28.7 0 0 28.7 0 64V448c0 35.3 28.7 64 64 64H320c35.3 
    0 64-28.7 64-64V154.5c0-17-6.7-33.3-18.7-45.3L274.7 18.7C262.7 6.7 246.5 0 229.5 0H64zm56 
    256c-13.3 0-24 10.7-24 24s10.7 24 24 24H264c13.3 0 24-10.7 24-24s-10.7-24-24-24H120zm0 
    96c-13.3 0-24 10.7-24 24s10.7 24 24 24H264c13.3 0 24-10.7 24-24s-10.7-24-24-24H120z"/>
      </svg>
  ...
  const d = (
    <li>
      ...
      >
        ...
        <span className="ml-3">Write DockerFile</span>
      </Link>
    </li>
  );
  ...
  const g = (
    <li>
      ...
      >
        ...
        <span className="ml-3">Screenshots</span>
      </Link>
    </li>
  );
  ...
  96c-13.3 0-24 10.7-24 24s10.7 24 24 24H264c13.3 0 24-10.7 24-24s-10.7-24-24-24H120z"/>
        ...
        <span className="ml-3">End Session</span>
      </Link>
    </li >)
